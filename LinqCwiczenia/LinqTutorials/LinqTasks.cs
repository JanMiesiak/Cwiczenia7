...
namespace LinqTutorials
{
    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts.Where(dept =>
                    Emps.All(emp => emp.Deptno != dept.Deptno) || Emps.Count(emp => emp.Deptno == dept.Deptno) == 5)
        ...
        {
            var result = Emps
                .Where(emp => emp.Job != null && emp.Job.Contains("A"))
                .GroupBy(emp => emp.Job)
        ...
        {
            var result = Emps
                .SelectMany(emp => Depts.DefaultIfEmpty(), (emp, dept) => dept)
                .ToList();
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps.Where(e => emps.Any(e2 => e2.Mgr == e.Mgr)).OrderBy(e => e.Ename)
